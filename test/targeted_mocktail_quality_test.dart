  ...
  for (var i = 1; i <= 10; i++) {
    test('view model validation $i', () async {
      final container = ProviderContainer(
        overrides: [auth.loginUsecaseProvider.overrideWithValue(login)],
      );
      ...
      verifyNever(
        () => login.call(const LoginUsecaseParams(email: '', password: '')),
      );
    });
  }
