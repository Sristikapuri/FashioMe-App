...
void main() {
  test(
    'requires language selection when only a legacy locale code exists',
    () async {
      ...
      expect(container.read(localeProvider.notifier).hasChosenLocale, isFalse);
    },
  );

  test(
    'records language selection after the user chooses a language',
    () async {
