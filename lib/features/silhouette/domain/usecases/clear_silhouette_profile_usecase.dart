...
final clearSilhouetteProfileUsecaseProvider = Provider<ClearSilhouetteProfileUsecase>((ref) {
  return ClearSilhouetteProfileUsecase(
    silhouetteRepository: ref.read(silhouette_repo.silhouetteRepositoryProvider),
  );
});

class ClearSilhouetteProfileUsecase implements UsecaseWithoutParams<bool> {
  ClearSilhouetteProfileUsecase({required ISilhouetteRepository silhouetteRepository})
  ...
  Future<Either<Failure, bool>> call() {
    return _silhouetteRepository.clearProfile();
  }
}
