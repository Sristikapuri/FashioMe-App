...
class MatchedShopProduct extends Equatable {
  const MatchedShopProduct({
    required this.id,
    required this.name,
  ...
  factory MatchedShopProduct.fromJson(Map<String, dynamic> json) {
    return MatchedShopProduct(
...
class DashboardRecommendation extends Equatable {
  ...
  factory DashboardRecommendation.fromJson(Map<String, dynamic> json) {
    return DashboardRecommendation(
      ...
      missingItemsToBuy: List<String>.from(
        json['missingItemsToBuy'] ?? const [],
      ),
      matchedProducts: (json['matchedProducts'] is List)
          ? (json['matchedProducts'] as List)
                .whereType<Map>()
                .map(
                  (item) => MatchedShopProduct.fromJson(
  ...
  Map<String, dynamic> toJson() => {
    ...
    'missingItemsToBuy': missingItemsToBuy,
    'matchedProducts': matchedProducts.map((item) => item.toJson()).toList(),
  };
...
class ChatMessage extends Equatable {
  ...
  Map<String, dynamic> toJson() => {'id': id, 'text': text, 'isUser': isUser};
...
class DashboardProfileData extends Equatable {
  ...
  factory DashboardProfileData.empty() => const DashboardProfileData(
    displayName: 'User',
    email: '',
    gender: '',
    heightCm: 172,
  ...
  factory DashboardProfileData.fromJson(Map<String, dynamic> json) {
    return DashboardProfileData(
      ...
      heightCm:
          ...
          int.tryParse(
            (json['heightCm'] ?? json['height'] ?? '172').toString(),
          ) ??
          172,
      weightKg:
          ...
          int.tryParse(
            (json['weightKg'] ?? json['weight'] ?? '64').toString(),
          ) ??
          64,
