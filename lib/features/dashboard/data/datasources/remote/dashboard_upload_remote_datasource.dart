...
final dashboardUploadRemoteDataSourceProvider = Provider<IDashboardUploadDataSource>((ref) {
  return DashboardUploadRemoteDataSource(apiClient: ref.read(apiClientProvider));
});
