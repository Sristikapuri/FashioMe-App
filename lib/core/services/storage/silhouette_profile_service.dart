...
/// Deprecated: kept only for backward compatibility with older imports.
/// Prefer using the silhouette feature's domain usecases/repository.
@Deprecated('Use silhouette domain usecases/repository instead.')
final silhouetteProfileServiceProvider = Provider<SilhouetteProfileService>((ref) {
...
class SilhouetteProfileService {
  ...
  Future<void> saveProfile(SilhouetteProfile profile) async {
    await _localDataSource.saveProfile(SilhouetteProfileModel.fromEntity(profile));
  }
